...
ADMINS = (
     ('Ricardo Portillo', 'portillo.ricardog@gmail.com'),
)
...
SECRET_KEY = 'h5!9259(aw7c16lhk%8#d)r0#b_d2r96e8m503!c7oei=i16^p'
...
ROOT_URLCONF = 'cm_manager.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cm_manager.wsgi.application'
